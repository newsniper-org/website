...
This guide covers the basics of MDX syntax and how to use it, as well as
a few examples.
...
This component accepts a Javascript date object and format it as a
string.
...
By default Micro has zero frameworks installed. If you install a
framework, components of that framework can be used in MDX files.

<Callout> Don’t forget to use [client
directives](https://docs.astro.build/en/reference/directives-reference/#client-directives)
to make framework components interactive. </Callout>
...
-   [Astro Usage
    Documentation](https://docs.astro.build/en/guides/markdown-content/#markdown-and-mdx-pages)
-   [Client
    Directives](https://docs.astro.build/en/reference/directives-reference/#client-directives)
